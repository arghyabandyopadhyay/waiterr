...
class MenuPageAll extends StatefulWidget {
  ...
  const MenuPageAll({Key? key, this.addOrderData}) : super(key: key);
  @override
              ...
              appBar: AppBar(
                ...
                leading: IconButton(
                  ...
                  onPressed: () => _isSearching!
                      ? null
                      : {setPreviousCartManager(), Navigator.of(context).pop()},
                ),
                actions: <Widget>[
                  IconButton(
                      icon: icon,
                                ...
                                Navigator.pushReplacement(
                                    ...
                                    PageRouteBuilder(
                                        pageBuilder: (context, animation1,
                                                animation2) =>
                                            MenuPageAll(
                                              addOrderData: widget.addOrderData,
                                            )))
                              }
                          });
                    },
                      ...
                      children: <Widget>[
                        ...
                        Flexible(
                          child: Container(
                              ...
                              child: FutureBuilder<List<List<MenuItemModel>>?>(
