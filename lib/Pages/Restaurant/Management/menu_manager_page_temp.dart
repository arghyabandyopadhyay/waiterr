...
class MenuManagerPageTemp extends StatefulWidget {
  // This widget is the root of your application.
  const MenuManagerPageTemp({Key? key}) : super(key: key);
  @override
  State<MenuManagerPageTemp> createState() => _MenuManagerPageTempState();
}

class _MenuManagerPageTempState extends State<MenuManagerPageTemp> {
  //Variables
  ...
  bool? _isSearching, _dataIsLoaded, _isFilterOn, _isLoading;
