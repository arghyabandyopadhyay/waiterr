...
class _OutletManagerPageState extends State<OutletManagerPage> {
  //Variables
                                                            ...
                                                            ? ListView.builder(
                                                                ...
                                                                itemBuilder:
                                                                  ...
                                                                  return ListTile(
                                                                    ...
                                                                    subtitle: Text(
                                                                        searchResult[index].outletSalePoint ??
                                                                            ""),
                                                                    onTap: () {
                                                                      Navigator.push(
                                                                          context,
                                                                          CupertinoPageRoute(
                                                                              builder: (context) => AddOutletPage(
                                                                                    outletDetail: searchResult[index],
                                                                                    isEdit: true,
                                                                                  )));
                                                                    },
                                                                  );
