...
import 'package:waiterr/Pages/Login/sign_in_page.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            buttonItem("assets/img/google.svg", "Continue with Google", 25,
                () async {
            ...
            buttonItem("assets/img/phone.svg", "Continue with Phone", 30, () {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(colors: GlobalTheme.buttonGradient),
        ),
        child: Center(
          child: circular
